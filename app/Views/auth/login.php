...
<body>
    <div class="main-wrapper">
        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center position-relative"
            style="background:url(<?= base_url() ?>assets/images/big/auth-b.jpg) no-repeat center center;">
            <div class="auth-box row">
                <div class="col-lg-7 col-md-5 modal-bg-img bg-conic-30"
                    style="background-image: url(<?= base_url() ?>assets/images/logo.jpeg);">
                </div>
                <div class="col-lg-5 col-md-7 bg-white">
                    <div class="p-3">
                        <h2 class="mt-3 text-center">Sign In</h2>
                        <p class="text-center">Masukkan username dan password anda.</p>
                        <form method="post" action="<?= base_url('auth/login') ?>" class="mt-4">
                            <div class="row">
                                <div class="col-lg-12">
                                ...
                                <div class="col-lg-12 text-center">
                                    <button type="submit" name="submit" class="btn w-100 btn-dark">Masuk</button>
                                </div>
                            </div>
                        </form>
                    </div>
